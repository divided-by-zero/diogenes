...
public class ClientExample 
{
	...
	private static final String PHOTOPATH = "/home/olli/workspace/Diogenes/photo1";
	 ...
	 */
	public static void trainPerson () throws FaceClientException, FaceServerException {
				...
				Thread t = new Thread(new Runnable() {
					...
					public void run() {
						try {
							...
							final String userlabel = tf.getText();
					    	...
					    	faceClient.saveTags(f.getTID(), USER_ID, userlabel);
					    	/*
	...
	public static void startDetection() throws FaceClientException, FaceServerException{
    	...
    	for (Face face : photo.getFaces()) {
    		JOptionPane.showMessageDialog(new JFrame(),
    				...
    				"The name of the person is: " + face.getLabel(), "Face Detection", JOptionPane.INFORMATION_MESSAGE		
    		);
    	}
	}
}